...
<div class="column is-one-fifth">
	<aside class="menu has-text-centered is-flex is-flex-direction-column">
		<ul class="menu-list box is-60-height">
			<li class="is-60-height-child"><a class="is-60-height-child is-flex is-align-items-center is-justify-content-center" href="/profile/"><?= CurrentUser::get()->getFullName() ?><br><?= GetMessage("ADMINISTRATOR_ROLE") ?></a></li>
		</ul>
