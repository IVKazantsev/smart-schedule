	...
	<aside class="menu has-text-centered is-flex is-flex-direction-column">
		...
		if ($arResult['USER_ROLE'] === 'Администратор'): ?>
			<ul class="menu-list box">
				<li>
					<a class="is-60-height is-flex is-align-items-center is-justify-content-center" href="/admin/"><?= GetMessage(
							"ADMIN_PANEL"
						) ?></a></li>
				<li>
					<a class="is-60-height is-flex is-align-items-center is-justify-content-center" href="/scheduling/"><?= GetMessage(
							"SCHEDULING"
						) ?></a></li>
				<li>
					<a class="is-60-height is-flex is-align-items-center is-justify-content-center" href="/"><?= GetMessage(
							"BACK_TO_SCHEDULE"
						) ?></a></li>
				<li>
					<a class="is-60-height is-flex is-align-items-center is-justify-content-center" href="/import/"><?= GetMessage(
							"IMPORT_FROM_EXCEL"
						) ?></a></li>
			</ul>
			<div class="box notes">
		...
		if ($arResult['ENTITY']): ?>
			<ul class="menu-list box" id="schedule-display-entity-list">
				<div class="mt-3 mb-3 is-flex is-align-items-center is-justify-content-center is-fullwidth"><?= GetMessage(
						'DISPLAY_BY'
					) ?>:
				</div>
				<?php
				foreach ($arResult['ENTITIES_FOR_DISPLAY'] as $key => $entity): ?>
					<li>
						<a href="/<?= $entity ?>/1/" class="display-entity is-60-height is-flex is-align-items-center is-justify-content-center <?= ($arResult['ENTITY']
							=== $entity) ? 'selected-sidebar-entity' : '' ?>">
