...
class SidebarComponent extends CBitrixComponent
{
	...
	{
		$entity = $this->arParams['SIDEBAR_ENTITY'];

		if(!$this->arParams['IS_SCHEDULE'])
		{
			return;
		}
		...
		{
			$this->arResult['SIDEBAR_ENTITY'] = $entity;
		}
		else
		{
			$this->arResult['SIDEBAR_ENTITY'] = DEFAULT_ENTITY_TO_DISPLAY;
		}
